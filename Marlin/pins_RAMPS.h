...
#define Z2_STEP_PIN         64   //Triển add
#define Z2_DIR_PIN          59   //Triển add
#define Z2_ENABLE_PIN       44   //Triển add
...
#define TEMP_1_PIN         13   // Analog Input //Cùng chân với Temp 0 *** Triển*
...
#define HEATER_0_PIN     RAMPS_D10_PIN
  ...
  #define HEATER_1_PIN   RAMPS_D10_PIN        //Cùng chân với Heat 0 *** Triển*
  #define FAN_PIN        RAMPS_D9_PIN
